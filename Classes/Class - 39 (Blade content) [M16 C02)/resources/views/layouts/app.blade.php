...
<div class="app-wrapper">
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
            <!--begin::Brand Link-->
            <a href="./summary.html" class="brand-link">
                <!--begin::Brand Image-->
                <img
                ...
                <!--end::Brand Image-->
                <!--begin::Brand Text-->
                <span class="brand-text fw-light">BookShop</span>
                <!--end::Brand Text-->
            </a>
            <!--end::Brand Link-->
        </div>
        ...
        <div class="sidebar-wrapper">
            <nav class="mt-2">
                ...
                >
                    ...
                    <li class="nav-item">
                        <a href="/authors" class="nav-link {{ $page === 'authorPage'?'active':'' }}">
                            <i class="nav-icon bi bi-speedometer"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('booksView') }}" class="nav-link {{ $page === 'book'?'active':'' }}">
                            <i class="nav-icon bi bi-speedometer"></i>
                            <p>Book Management</p>
                        </a>
                    </li>
